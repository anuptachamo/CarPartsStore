	...
	<div class="container">
		...
		<form>
			...
			<div class="col-sm-4">
  			...
  			<input type="text" class="form-control"Placeholder="01-XXXXXX" id="m=Mno" name="mno" required>
  			<div class="valid-feedback">Valid.</div>
    		<div class="invalid-feedback">Please fill out this field.</div>
			</div>
			...
			<div class="col-sm-4">
  			...
  			<input type="text" class="form-control"Placeholder="XXXXX" id="ManagerId" name="managerid" required>
  			<div class="valid-feedback">Valid.</div>
    		<div class="invalid-feedback">Please fill out this field.</div>
			</div>
			</div>
			<!-- row End(mobile no,email and mananger id) -->
		</form>
